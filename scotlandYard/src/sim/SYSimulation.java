 ...
 * Es können grundsaetzlich zwei Bewegungen visualisiert werden: <p>
 ...
 * Durch Erzeugung einer Ojektinstanz wird das Hauptfenster mit der Scotland Yard Karte geöffnet. Das Programm unterstuetzt das
 ...
 * <b>Play:</b><br>Setzt die Simulation nach druecken von 'Pause' wieder fort. Ebenso kann eine Sequenz nach deren Ablauf wiederholt werden. <br>
 * <b>Pause:</b><br>Pausiert die laufende Simulation, die Simulation kann mit 'Play' wieder fortgesetzt werden. <br>
 * <b>Stop:</b><br>Bricht die laufende Sequenz ab und die naechste Sequenz wird gestartet. Falls keine Sequenzen mehr vorhanden sind, stoppt
 ...
 * <b>Status Message:</b><br>Zeigt den aktuellen Status an bzw. welche Aktionen als naechstes möglich sind. <p>
 * <b>Beispielanwendung:</b><p>
 * Die Klasse <b>SYDemo</b> enthaelt eine Beispielanwendung mit zwei Simulationssequenzen.
...
public class SYSimulation {
	 ...
	 * hinzugefuegt werden.<p>
	 * <b>Achtung:</b> Der Aufruf von startSequence() ist <b>nicht blockierend</b>, d.h. das Hauptprogramm laeuft weiter, waehrend eine Simulationssequenz laeuft. Da die
	 * Simulation zeitverzögert parallel zum Hauptprogramm laeuft, wird sie durch einen separaten Thread durchgefuehrt.
	 * @param name Der Name fuer die Simulationssequenz, wird im Simulationsfenster in der Titelleiste angezeigt, damit der Anwender weiß, welche Sequenz
	 ...
	 * @param color Die Farbe fuer den Kreis, mit der die Station markiert werden soll.
	 */
